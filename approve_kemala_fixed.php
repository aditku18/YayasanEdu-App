...
// Get the admin user (using admin_user_id instead of email)
$user = User::find($foundation->admin_user_id);
if (!$user) {
...
echo "Admin can now login at: http://{$foundation->subdomain}.localhost\n";
