...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('plans', function (Blueprint $table) {
            $table->integer('max_teachers')->nullable()->after('max_students');
            $table->boolean('has_cbt')->default(false)->after('max_teachers');
            ...
            $table->integer('max_parents')->nullable()->after('max_users');
            $table->integer('storage_gb')->default(1)->after('max_parents');
            ...
            $table->text('highlight_features')->nullable()->after('has_sms_notification');
            $table->string('duration_days')->default(30)->after('highlight_features');
        });
    }
