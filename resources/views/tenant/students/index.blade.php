...
<head>
    ...
    <title>{{ config('app.name', 'EduSaaS') }} — Data Siswa</title>
    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-white shadow-lg border-r border-gray-200 flex flex-col">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                ...
                <a href="{{ route('tenant.students.index') }}" class="flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 hover:text-gray-900 transition-colors {{ request()->routeIs('tenant.students.*') ? 'bg-green-50 text-green-700 border-r-2 border-green-500' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <header class="bg-white shadow-sm border-b border-gray-200 px-8 py-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Kelola data siswa di yayasan Anda</p>
                    </div>
                    <div class="flex items-center gap-4">
                        ...
                        @endif
                        <button class="px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg shadow-sm transition-colors">
                            Tambah Siswa
                        </button>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">Guru</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    <div class="p-6 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            ...
                            <button class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg shadow-sm transition-colors flex items-center gap-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="p-6">
                        @if(\App\Models\Student::count() > 0)
                            <div class="space-y-4">
                                @foreach(\App\Models\Student::with('school')->get() as $student)
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-500">
                                                    NIS: {{ $student->nis ?? '-' }} • 
                                                    NISN: {{ $student->nisn ?? '-' }} • 
                                                    {{ $student->school->name ?? 'Sekolah belum ditentukan' }}
                                                </p>
                                            </div>
                                        </div>
                        ...
                        @else
                            ...
                            <div class="text-center py-12">
                                ...
                                <p class="text-gray-600 mb-6">Tambahkan siswa pertama untuk memulai mengelola data siswa.</p>
                                <button class="px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg shadow-sm transition-colors">
