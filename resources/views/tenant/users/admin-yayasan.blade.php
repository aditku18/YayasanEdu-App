            ...
            <div class="relative z-10 text-center">
                <div class="flex items-center justify-center gap-3 mb-6">
                    <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 8 0 4 4 0 00-8 0zM4.354 12a4 4 0 110 8 0 4 4 0 00-8 0z"/>
                        </svg>
                    </div>
                    <h1 class="text-3xl md:text-4xl font-bold">Admin Yayasan</h1>
                </div>
                <p class="text-primary-100 text-lg leading-relaxed mb-8 max-w-2xl mx-auto">
                    Kelola administrator yayasan dan pengguna sistem
                </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 text-center">
                        ...
                        <p class="text-primary-100 text-sm">Total Admin</p>
                    </div>
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 text-center">
                        <p class="text-3xl font-black text-white">{{ $users->where('email_verified_at', '!=', null)->count() }}</p>
                        <p class="text-primary-100 text-sm">Terverifikasi</p>
                    </div>
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 text-center">
                        <p class="text-3xl font-black text-white">{{ $users->where('email_verified_at', null)->count() }}</p>
                        <p class="text-primary-100 text-sm">Belum Terverifikasi</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-gradient-to-r from-slate-50 to-white p-8 border-b border-slate-100">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h2 class="text-2xl font-bold text-slate-900">Daftar Administrator Yayasan</h2>
                            <p class="text-slate-600">Kelola hak akses administrator yayasan</p>
                        </div>
                    </div>
                    <div class="text-center">
                        <p class="text-3xl font-black text-primary-600">{{ $users->count() }}</p>
            ...
            <div class="p-8">
                                    ...
                                    <tr class="border-b border-slate-100 hover:bg-slate-50 transition-colors animate-slide-in-left {{ $index % 3 === 0 ? 'animate-delay-1' : ($index % 3 === 1 ? 'animate-delay-2' : 'animate-delay-3') }}">
                                        ...
                                        <td class="p-4">
                                            <div class="flex items-center gap-2">
                                                <button class="p-2 bg-primary-50 hover:bg-primary-100 text-primary-600 rounded-lg transition-colors" title="Edit User">
                ...
                @else
                    <div class="text-center py-16">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 mb-4">Belum Ada Administrator</h3>
                        <p class="text-slate-600 max-w-md mx-auto mb-8">Belum ada administrator yayasan yang terdaftar dalam sistem.</p>
                        <button class="group px-6 py-3 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
