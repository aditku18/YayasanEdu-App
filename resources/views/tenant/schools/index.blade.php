...
<head>
    ...
    <title>{{ config('app.name', 'EduSaaS') }} — Data Sekolah</title>
    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-white shadow-lg border-r border-gray-200 flex flex-col">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                ...
                <a href="{{ route('tenant.schools.index') }}" class="flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 hover:text-gray-900 transition-colors {{ request()->routeIs('tenant.schools.*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-500' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                    </svg>
                    Manajemen Unit
        ...
        <div class="flex-1 flex flex-col">
            ...
            <header class="bg-white shadow-sm border-b border-gray-200 px-8 py-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Data Sekolah</h1>
                        <p class="text-gray-600 mt-1">Kelola data sekolah di yayasan Anda</p>
                    </div>
                    <div class="flex items-center gap-4">
                        ...
                        @endif
                        <button class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-sm transition-colors">
                            Tambah Sekolah
                        </button>
                    </div>
                </div>
            ...
            <main class="flex-1 p-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    <div class="p-6 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <h2 class="text-xl font-bold text-gray-900">Daftar Sekolah</h2>
                            <button class="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-lg shadow-sm transition-colors flex items-center gap-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="p-6">
                        @if(\App\Models\SchoolUnit::count() > 0)
                            <div class="space-y-4">
                                @foreach(\App\Models\SchoolUnit::all() as $school)
                                    <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-500">{{ $school->address ?? 'Alamat belum diisi' }}</p>
                                            </div>
                                        </div>
                        ...
                        @else
                            ...
                            <div class="text-center py-12">
                                ...
                                <h3 class="text-lg font-semibold text-gray-900 mb-2">Belum ada sekolah</h3>
                                <p class="text-gray-600 mb-6">Tambahkan sekolah pertama untuk memulai mengelola data siswa dan guru.</p>
                                <button class="px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-lg shadow-sm transition-colors">
