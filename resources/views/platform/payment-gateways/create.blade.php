<x-platform-layout>
    <x-slot name="header">Provision Gateway</x-slot>
    <x-slot name="subtitle">Inisialisasi konfigurasi gerbang pembayaran baru</x-slot>
    ...
    <form action="{{ route('platform.payment-gateways.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="type" name="type" required
                                ...
                                <option value="third_party" {{ old('type') === 'third_party' ? 'selected' : '' }}>Third Party Provider</option>
                                <option value="custom" {{ old('type') === 'custom' ? 'selected' : '' }}>Custom Logic / Manual</option>
                            </select>
                        </div>

                        <div>
                            <label for="priority" class="block text-sm font-medium text-gray-700 mb-2">System Priority</label>
                            <input type="number" id="priority" name="priority" value="{{ old('priority', 1) }}" min="1" required
                                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                        <label class="group relative cursor-pointer">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', '1') ? 'checked' : '' }} class="peer hidden">
                        ...
                        <label class="group relative cursor-pointer">
                            <input type="checkbox" name="supports_recurring" value="1" {{ old('supports_recurring') ? 'checked' : '' }} class="peer hidden">
                        ...
                        <label class="group relative cursor-pointer">
                            <input type="checkbox" name="supports_split_payment" value="1" {{ old('supports_split_payment') ? 'checked' : '' }} class="peer hidden">
                        ...
                        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
                            @foreach(['credit_card', 'bank_transfer', 'virtual_account', 'ewallet', 'qris', 'cstore'] as $method)
                                <label class="flex items-center gap-2 p-3 bg-gray-50 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-100 transition-all has-[:checked]:border-indigo-500 has-[:checked]:bg-indigo-50">
                                    <input type="checkbox" name="supported_methods[]" value="{{ $method }}" class="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="number" id="admin_fee_rate" name="admin_fee_rate" value="{{ old('admin_fee_rate', 0) }}" step="0.01" required
                                       class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all">
                            </div>
                            <div>
                                <label for="fixed_admin_fee" class="block text-sm font-medium text-gray-700 mb-2">Fixed Operational Fee (IDR)</label>
                                <input type="number" id="fixed_admin_fee" name="fixed_admin_fee" value="{{ old('fixed_admin_fee', 0) }}" step="1" required
                                       class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all">
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="number" id="min_amount" name="min_amount" value="{{ old('min_amount', 0) }}" required
                                       class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all">
                            </div>
                            <div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="password" id="server_key" name="config[server_key]" value="{{ old('config.server_key') }}"
                                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all">
                        </div>

                        <div>
                            <label for="client_key" class="block text-sm font-medium text-gray-700 mb-2">App Client Key (API)</label>
                            <input type="password" id="client_key" name="config[client_key]" value="{{ old('config.client_key') }}"
                                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all">
                        </div>

                        <div>
                            <label for="merchant_id" class="block text-sm font-medium text-gray-700 mb-2">Merchant Identifier / Bank Name</label>
                            <input type="text" id="merchant_id" name="config[merchant_id]" value="{{ old('config.merchant_id') }}"
                                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                        ...
                        <div>
                            ...
                            <input type="text" id="bank_name" name="config[bank_name]" value="{{ old('config.bank_name') }}"
                                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                        ...
                        <div>
                            ...
                            <input type="text" id="account_number" name="config[account_number]" value="{{ old('config.account_number') }}"
                                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                        ...
                        <div>
                            ...
                            <input type="text" id="account_name" name="config[account_name]" value="{{ old('config.account_name') }}"
                                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                        ...
                        <div>
                            ...
                            <input type="text" id="bank_branch" name="config[bank_branch]" value="{{ old('config.bank_branch') }}"
                                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                        ...
                        <div>
                            ...
                            <input type="url" id="api_url" name="config[api_url]" value="{{ old('config.api_url') }}"
                                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                        ...
                        <div>
                            ...
                            <input type="password" id="webhook_token" name="config[webhook_token]" value="{{ old('config.webhook_token') }}"
                                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all">
                        </div>
                    </div>
                    ...
                    <div class="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-100 flex gap-3 text-blue-700">
                        ...
                        <p class="text-xs leading-relaxed">Configuration data is secured using AES-256 encryption before storage.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 space-y-4">
                    ...
                    <p class="text-center text-xs text-gray-500">Double check configuration before deployment.</p>
                </div>
            </div>
        </div>
    </form>
