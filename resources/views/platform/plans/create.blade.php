<x-platform-layout>
    ...
    <x-slot name="subtitle">Tambahkan paket langganan baru ke platform</x-slot>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <textarea name="features_text" id="features_text" rows="6" placeholder="Setiap fitur pada baris baru"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">{{ old('features_text') }}</textarea>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="max_users" id="max_users" value="{{ old('max_users', 1) }}" required min="1"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" />
                                    @error('max_users')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="number" name="max_students" id="max_students" value="{{ old('max_students', 1) }}" required min="1"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" />
                                    @error('max_students')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
