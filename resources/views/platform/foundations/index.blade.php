...
@section('title', 'Semua Yayasan')

@section('content')
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    {{-- Page Header --}}
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900">Semua Yayasan</h1>
        <p class="text-gray-600 mt-1">Kelola dan pantau semua yayasan terdaftar</p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-6 text-white shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-purple-100 text-sm font-medium">Trial</p>
                    <p class="text-3xl font-bold mt-1">{{ number_format($stats['trial']) }}</p>
                </div>
                <div class="bg-white/20 rounded-lg p-3">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-xl p-6 text-white shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold mt-1">{{ number_format($stats['pending']) }}</p>
                </div>
                <div class="bg-white/20 rounded-lg p-3">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
        ...
        <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl p-6 text-white shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-indigo-100 text-sm font-medium">Baru Bulan Ini</p>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-sm text-gray-500">Premium Plans</p>
                    <p class="text-2xl font-bold text-gray-900">{{ number_format($stats['with_premium_plans']) }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 mb-6">
        <form method="GET" action="{{ route('platform.foundations.index') }}" class="space-y-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('platform.foundations.index') }}" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">
                    Reset
                </a>
            </div>
        </form>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="p-6 border-b border-gray-100">
                    <div class="flex items-center justify-between">
                        <h2 class="text-lg font-bold text-gray-900">Daftar Semua Yayasan</h2>
                            ...
                            @forelse($foundations as $foundation)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        @elseif($foundation->status == 'pending')
        ...
        <div class="space-y-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-2">
                                <div class="w-24 bg-gray-200 rounded-full h-2">
                                    <div class="bg-indigo-600 h-2 rounded-full" style="width: {{ $stats['total'] > 0 ? ($status['count'] / $stats['total']) * 100 : 0 }}%"></div>
                                </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <div class="space-y-2">
                    <a href="{{ route('platform.foundations.index', request()->query()) . '&export=1' }}" 
                    ...
                    <a href="{{ route('platform.foundations.create') }}" 
                       class="w-full px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm inline-flex items-center justify-center">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-sm font-bold text-gray-900">{{ number_format($stats['total_schools']) }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-600">Total Pengguna</span>
                        <span class="text-sm font-bold text-gray-900">{{ number_format($stats['total_users']) }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-600">Rata-rata Sekolah</span>
                        <span class="text-sm font-bold text-gray-900">{{ $stats['total'] > 0 ? round($stats['total_schools'] / $stats['total'], 1) : 0 }}</span>
                    </div>
                </div>
            </div>
        </div>
