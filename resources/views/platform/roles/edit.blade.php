<x-platform-layout>
    ...
    <x-slot name="subtitle">Perbarui informasi role {{ $role->name }}</x-slot>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <form action="{{ route('platform.roles.update', $role->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="flex justify-end gap-3">
                    <a href="{{ route('platform.roles.show', $role->id) }}" class="px-6 py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-medium">
                        Batal
                    </a>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-blue-50 rounded-xl p-6 border border-blue-100">
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-blue-700 mt-1">Pilih permissions yang ingin diberikan kepada role ini. Permissions yang dipilih akan menentukan apa yang dapat dilakukan oleh pengguna dengan role ini.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl p-6 text-white shadow-lg">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        <span class="text-indigo-100">Permissions Terpilih</span>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 space-y-3">
                    <a href="{{ route('platform.roles.show', $role->id) }}" class="w-full flex items-center justify-center px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">
