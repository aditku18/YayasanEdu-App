        ...
        <form method="POST" action="{{ route('platform.plans.update', $plan->id) }}">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500">{{ old('description', $plan->description) }}</textarea>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    {{-- Features --}}
                    <div>
                        <label for="features" class="block font-medium text-sm text-gray-700 mb-2">Fitur (satu per baris)</label>
                        <textarea name="features_text" id="features" rows="5" placeholder="Fitur 1&#10;Fitur 2&#10;Fitur 3"
                            class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500">{{ old('features_text', is_array($plan->features) ? implode("\n", $plan->features) : '') }}</textarea>
            ...
            <div class="flex items-center justify-end gap-4 mt-8 pt-6 border-t border-gray-200">
                ...
                <button type="submit" class="px-6 py-2.5 bg-primary-600 text-white rounded-xl font-medium hover:bg-primary-700 transition">
                    Simpan Perubahan
                </button>
            </div>
        </form>
